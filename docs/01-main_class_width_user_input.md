...
![A CRT diagram with ions gun and anodes deflectors](images/figure-crt.jpg "A 
CRT diagram with ions gun and anodes deflectors (c) myself with my own hands !")
...
![The basic Main loop explained with a pencil: the method to keep a fixed 
frame rate !](images/figure-game-loop.jpg "the basic Main loop explained with a 
pencil: the method to keep a fixed frame rate ! (c) myself with my own hands !")
...
> **INFO** <br/>We will discover the configuration mechanism on the 3rd
> chapter.
